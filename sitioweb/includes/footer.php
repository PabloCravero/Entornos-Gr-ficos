  ...
  <div class="container-footer">
    <div class="row-footer">
      ...
      <div class="col-md-2">
        ...
        <p>
          <strong>Consultas generales:</strong> totalstoreshopping@gmail.com<br>
          <strong>Dueño del shopping:</strong> pedrorodriguez@gmail.com <br>
          <strong>Atención al cliente:</strong> cuti@gmail.com <br>
          <strong>Soporte técnico:</strong> scaloneta@gmail.com<br>
          <strong>Desarrolladores web:</strong> ingesimon@gmail.com / ingecravero@gmail.com
        </p>
      </div>
    </div>
  </div>
